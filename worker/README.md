...
```
ALLOWED_ORIGINS=https://herambve.github.io,http://localhost:4321
```
...
```javascript
const corsHeaders = {
  'Access-Control-Allow-Origin': 'https://herambve.github.io', // Your domain
...
- `https://herambve.github.io/blog/inside-a-transformer/`
...
If you want a cleaner URL like `https://api.herambve.github.io/views/{slug}`:

1. Go to Cloudflare Dashboard → Workers & Pages → your worker
2. Click "Triggers" → "Add Custom Domain"
3. Configure your subdomain (e.g., `api.herambve.github.io`)
