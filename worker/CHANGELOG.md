...
- Values must include full origin (scheme + domain), e.g., https://herambve.github.io,http://localhost:4321
...
**Required:**
- `ALLOWED_ORIGINS`: Comma-separated list of allowed origins (e.g., "https://herambve.github.io,http://localhost:4321")
